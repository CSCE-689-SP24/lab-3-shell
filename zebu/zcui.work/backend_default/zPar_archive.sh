...
targetfiles=" gridjob_profiling_parameters.tcl /opt/coe/synopsys/zebu/Q-2020.03-SP1-4/etc/zpar/zPar_from_zCui.tcl zPar_cmds.tcl work.Part_0/zPar_cmds.tcl incremental_compile.tcl /opt/coe/synopsys/zebu/Q-2020.03-SP1-4/etc/zpar/zPar_script.tcl zPar_target_conf.tcl zPar_design_conf.tcl work.Part_0/zPar_design_conf.tcl work.Part_0/zPar_core_conf.tcl zPar_dve.tcl /home/faculty/d/davidkebo/davidkebo/csce689/labs/lab-3-solution/zebu/zcui.work/utf_generatefiles/zPar_config.tcl /home/faculty/d/davidkebo/davidkebo/csce689/labs/lab-3-solution/zebu/zcui.work/utf_generatefiles/new_zPar_config.tcl /opt/coe/synopsys/zebu/Q-2020.03-SP1-4/etc/ztime/common_eval_params.tcl /opt/coe/synopsys/zebu/Q-2020.03-SP1-4/etc/ztime/v7_eval_params.tcl ../utf_generatefiles/zTime_config.tcl ../utf_generatefiles/new_zTime_config.tcl "
